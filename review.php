    ...
    <div class="review-container">
            <div class="reviews-container">
                ...
                <div class="reviews">
                    ...
                    <button class="view-more-btn" onclick="review.php">More Student's Voice</button>
                </div>
             </div>
            ...
            <div class="reviews-container">
                ...
                <div class="reviews">
                    ...
                    <button class="view-more-btn" onclick="review.php">More Teacher's Voice</button>
                </div>
            </div>
        </div>
        <hr>

        <h4>Want To Post Your Voice? <a href="feedbackpost.php">Click Here..</a></h4>
        <hr>
