...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO studentsneed (name, category, subject, location, contactmail, note) 
            VALUES ('$name', '$category', '$subject', '$location', '$email', '$note')";

    if ($conn->query($sql) === TRUE) {
        header("Location: needTutor.php");
    } else {
