...
<body>
    ...
    <div class="searchbar-nav">
        <h3>Search Tutor's Post Here</h3>
        <div class="search-bar">
            <!--
            <select name="city" id="city">
                <option value="city1">- - City - -</option>
                <option value="city2">Ramgarh</option>
                <option value="city3">Ranchi</option>
                <option value="city4">Hazaribagh</option>
                <option value="city5">Pondicherry</option>
                <option value="city6">Chennai</option>
                <option value="city7">Trichi</option>
                
            </select>
            <select name="qualification" id="qualification">
                <option value="city1">- - Qualification - -</option>
                <option value="city2">Phd</option>
                <option value="city3">B.ed</option>
                <option value="city4">Mtech</option>
                <option value="city5">MSc</option>
                <option value="city5">BSc</option>
                <option value="city5">Net</option>
            </select>
                -->
            <input type="text" name="searchquery" id="searchquery" placeholder="Course...   Topic...   Class...   Faculty...   Subject...">
    ...
    <h4>Want To Post Your Need? <a href="studentPost.php">Click Here..</a></h4>
    <hr>
